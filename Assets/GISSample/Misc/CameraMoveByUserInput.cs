...
namespace GISSample.Misc
{
    ...
    /// </summary>
    public class CameraMoveByUserInput : GISSampleInputActions.ICameraMoveActions, ISubComponent
    {
        ...
        private GISSampleInputActions.CameraMoveActions input;
        ...
        {
            // ユーザーの操作を受け取る準備
            input = new GISSampleInputActions.CameraMoveActions(new GISSampleInputActions());
