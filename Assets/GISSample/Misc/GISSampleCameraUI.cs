...
namespace GISSample.Misc
{
    ...
    public class GISSampleCameraUI : ISubComponent, GISSampleInputActions.ISelectCamPosActions
    {
        private GISSampleInputActions.SelectCamPosActions input;
        ...
        public GISSampleCameraUI(LandscapeCamera landscapeCamera, VisualElement uiRoot, VisualElement[] subMenuUxmls)
        {
        ...
        public void OnEnable()
        {
            ...
            input = new GISSampleInputActions.SelectCamPosActions(new GISSampleInputActions());
        ...
        private void OnToggleWalkModeValueChanged(ChangeEvent<bool> evt)
        {
            if (!isNotNoticeToggleWalkCallback)
            {
                ...
                if (GISSampleCameraState.SelectWalkPoint == landscapeCamera.GetCameraState())
        ...
        public void OnSelectPosByInput(InputAction.CallbackContext context)
        {
            ...
            if (context.started && GISSampleCameraState.SelectWalkPoint == landscapeCamera.GetCameraState() && !isMouseOverUI)
            {
        ...
        private void HandleSetCameraCalled()
        {
            ...
            else
            {
                ...
                if (cameraState == GISSampleCameraState.Walker)
                {
